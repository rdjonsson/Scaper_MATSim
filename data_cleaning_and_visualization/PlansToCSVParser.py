...
output_csv_file1 = os.path.join(current_directory, f"{folder}\plans_{file_suffix}.xml")
output_csv_file2 = os.path.join(current_directory, f"{folder}\legs_{file_suffix}.xml")
...
transformed_df.to_csv(os.path.join(current_directory, f'{folder}\plans_{file_suffix}.csv'))
...
df_final.to_csv(os.path.join(current_directory, f'{folder}\legs_{file_suffix}.csv'))
